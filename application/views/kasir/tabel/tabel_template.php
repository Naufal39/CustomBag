              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <?php foreach($list_temp as $lt): ?>
                    ...
                    <td><?=$lt->jenis_tas?></td>
                    <td><?=$lt->bag_depan?></td>
                    <td><?=$lt->bag_belakang?></td>
                    <!-- <td><img src="<?=base_url('assets/images/'.$lt->photo)?>" style="width:300px; height:150"></td> -->
                    
                    <td><a type="button" class="btn btn-info"  href="<?=base_url('gudang/barang_masuk_template/'.$lt->id_template_product)?>" name="btn_update" style="margin:auto;"><i class="fa fa-pencil" aria-hidden="true"></i></a></td>
