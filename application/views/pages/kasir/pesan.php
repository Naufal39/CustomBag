...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gray-900 sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Sidebar - Brand -->
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url();?>kasir">
        ...
        <div class="container-fluid">
          ...
          <div class="col-xl-8 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <?php endif; ?>
                <div class="card-body">
                <form action="<?php base_url('kasir/product/add') ?>" method="post" enctype="multipart/form-data" >
