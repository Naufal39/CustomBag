...
<head>
  ...
  <title>gudang | Data Barang Masuk</title>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?= base_url('gudang/form_barangmasuk')?>"><i class="fa fa-circle-o"></i> Tambah Pesanan Masuk</a></li>
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?= base_url('gudang/tabel_barangmasuk')?>"><i class="fa fa-circle-o"></i> Pesanan Masuk</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary" style="width:94%;">
            ...
            <!-- form start -->
            <div class="container">
            <form action="<?=base_url('gudang/proses_databarang_masuk_update')?>" role="form" method="post">
            ...
            <?php } ?>
              ...
              <div class="box-body">
                ...
                <div class="form-group" style="display:inline-block;">
                  ...
                  <input type="text" name="kode_barang" required style="width: 90%;margin-right: 67px;margin-left: 11px;" class="form-control" id="kode_barang" readonly="readonly" value="<?=$d->kode_barang?>">
                </div>
                <div class="form-group" style="display:inline-block;">
              ...
              <div class="form-group" style="display:inline-block;">
                  ...
                  <select class="form-control" name="jenis_tas" style="width:90%;margin-right: 67px;">
                    <?php foreach($list_tas as $t){?>
                      <?php if($d->tas == $t->nama_tas){?>
                    <option value="<?=$d->tas?>" selected=""><?=$t->nama_tas?></option>
                    <?php }else{?>
              ...
              <div class="form-group" style="display:inline-block;">
                  ...
                  <select class="form-control" name="nama_bahan" style="width:110%;margin-right: 18px;">
                    <?php foreach($list_bahan as $b){?>
                      <?php if($d->bahan == $b->nama_bahan){?>
                    <option value="<?=$d->bahan?>" selected=""><?=$b->nama_bahan?></option>
                    <?php }else{?>
              ...
              <div class="form-group" style="display:inline-block;">
                  ...
                  <input type="text" name="bag_depan" style="width:90%;margin-right: 67px;" class="form-control" id="nama_Barang" placeholder="Bagian Depan"  value="<?=$d->bag_depan?>">
              </div>
              <div class="form-group" style="display:inline-block;">
                  <label for="nama_Barang" style="width:73%;">Bagian Belakang</label>
                  <input type="text" name="bag_belakang" style="width:90%;margin-right: 67px;" class="form-control" id="nama_Barang" placeholder="Bagian Belakang"  value="<?=$d->bag_belakang?>">
              </div>
                <div class="form-group" style="display:inline-block;">
            ...
            <div class="form-group" style="display:inline-block;">
                  ...
                  <input type="text" name="total_harga" style="width:90%;margin-right: 67px;" class="form-control" id="nama_Barang" placeholder="Total Harga"  value="<?=$d->total_harga?>">
              </div>
            <?php } ?>
              <!-- /.box-body -->
