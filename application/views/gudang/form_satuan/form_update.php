      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary" style="width:94%;">
            ...
            <!-- form start -->
            <div class="container">
            <form action="<?=base_url('gudang/proses_satuan_update')?>" role="form" method="post">
                ...
                <div class="form-group">
                  <?php foreach($data_satuan as $d){ ?>
                    ...
                    <div class="box-footer" style="width:93%;">
                      ...
                      <a type="button" class="btn btn-info" style="width:13%;margin-right:29%" href="<?=base_url('gudang/tabel_satuan')?>" name="btn_listsatuan"><i class="fa fa-table" aria-hidden="true"></i> Lihat Satuan</a>
